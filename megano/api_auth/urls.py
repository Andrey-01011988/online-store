...
from .views import SignInView, SignUpView, SignOutView, ProfileView, ChangePasswordView, ProfileAvatarUpdateView
...
urlpatterns = [
    ...
    path("profile/avatar", ProfileAvatarUpdateView.as_view(), name="avatar"),
]
